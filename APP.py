...
df_modelisation = pd.read_csv("df_modelisation.csv", sep =",")

df_modelisation1 = pd.read_csv("df_modelisation1.csv", sep =",")
...
if page == pages[4]:
    ...
    X = df_modelisation1.drop(columns=[target])  # Suppression de la colonne cible
    y = df_modelisation1[target]
